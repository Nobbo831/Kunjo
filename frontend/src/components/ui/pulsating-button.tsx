  ...
  (
    ...
    return (
      ...
      >
        ...
        <span
          aria-hidden="true"
          className={cn("pointer-events-none absolute inset-0 rounded-[inherit] bg-inherit")}
          style={{
            animation:
              variant === "pulse"
                ? `pulse ${duration} ease-out infinite`
                : `pulse-ripple ${duration} cubic-bezier(0.16, 1, 0.3, 1) infinite`,
          }}
        />
      </button>
    )
